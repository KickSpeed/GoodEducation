 ...
 */
public class EntryAdapterTemp extends RecyclerView.Adapter<EntryAdapterTemp.EntryViewHolder>{
    ...
    public EntryAdapterTemp(List<EntryMenuItem> items, EntryActivity activity){
        this.mItemList = items;
        this.mEntryActivity = activity;
        mIsFromSearchActivity = false;
    }

    public EntryAdapterTemp(List<EntryMenuItem> items, SearchActivity activity){
        this.mItemList = items;
